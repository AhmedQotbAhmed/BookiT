...
import static Common.Common.getGoogleApI;
import static core.BookitApplication.getAppContext;
...
public class HomeFragment extends Fragment implements OnMapReadyCallback,
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        setUpLocation();
        myServuce= getGoogleApI();



        return root;

        places  = (PlaceAutocompleteFragment)getActivity().getFragmentManager().findFragmentById(R.id.going_loc_map_edt);
